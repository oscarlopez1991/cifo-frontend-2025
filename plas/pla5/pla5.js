...
pi_sign = "π"
pi_text = "The number " + pi_sign + " is a mathematical constant, approximately equal to " + pi + ", defined in..."
...
for (const key in laptop) {
    ...
    if (value instanceof Array) {
        ...
        console.log(`${key} property is an object with ${Object.keys(value).length} fields`)
    } else {
